...
const MOCK_PRODUCTS: Omit<Product, 'status' | 'vendorId'>[] = [
    ...
    price: '$45.00',
    tieredPricing: [
        { quantity: 50, price: '$42.00' },
        { quantity: 100, price: '$40.00' },
        { quantity: 250, price: '$38.00' },
    ],
  ...
  // Add other mock products with the new fields
  {
    ...
    tieredPricing: [
        ...
        { quantity: 50, price: '$65.00' },
        { quantity: 100, price: '$60.00' },
    ],
  ...
  },
  {
    ...
    price: '$95.00',
    tieredPricing: [
        { quantity: 200, price: '$90.00' },
        { quantity: 500, price: '$85.00' },
    ],
