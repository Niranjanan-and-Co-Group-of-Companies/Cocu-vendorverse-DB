...
async function seedProductsIfEmpty() {
    ...
    const MOCK_PRODUCTS: Omit<Product, 'id' | 'status' | 'vendorId' | 'shipsFromPincode' | 'createdAt' | 'updatedAt' | 'mainVariantId' | 'packaging'>[] = [
    ...
    MOCK_PRODUCTS.forEach((product) => {
        ...
        batch.set(docRef, { 
            ...product, 
            packaging: { weight: product.weight, dimensions: product.dimensions }, // Nest weight and dimensions
            id: docRef.id,
