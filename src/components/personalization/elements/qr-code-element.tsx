...
interface QrCodeElementComponentProps {
    element: QrCodeElement;
    canvasRef: React.RefObject<HTMLDivElement>;
    constraintArea: CustomizationArea | null;
}

export function QrCodeElementComponent({ element, canvasRef, constraintArea }: QrCodeElementComponentProps) {
        ...
        >
            ...
            >
                ...
                >
                    <QRCode
                        value={element.value}
                        size={Math.min(size.width, size.height) - 8}
