...
import { StudioCanvas } from '@/components/personalization/studio-canvas';
import { StudioRightPanel } from '@/components/personalization/studio-right-panel';
import { CorporateStudioLeftPanel } from './corporate-studio-left-panel';
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs"
import { Brush, Image as ImageIcon, Sparkles } from 'lucide-react';

interface CorporateCustomizationStudioProps {
  product: Product;
}

export function CorporateCustomizationStudio({ product }: CorporateCustomizationStudioProps) {
    ...
    <>
      ...
      <div className="hidden md:grid md:grid-cols-[280px_1fr_320px] h-full gap-4 p-4">
        ...
        <div className="bg-card rounded-lg border h-full overflow-hidden">
          <CorporateStudioLeftPanel product={product} />
        </div>
