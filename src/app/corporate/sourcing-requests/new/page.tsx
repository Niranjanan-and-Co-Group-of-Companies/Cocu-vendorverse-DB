...
import { Calendar as CalendarIcon, UploadCloud, Send, X, Paperclip, ArrowLeft } from 'lucide-react';
    ...
    return (
        <>
            <div className="flex flex-col gap-6 max-w-4xl mx-auto">
                 <Link href="/corporate/sourcing-requests" className="inline-flex items-center text-sm font-medium text-muted-foreground hover:text-foreground">
                    <ArrowLeft className="mr-2 h-4 w-4" />
                    Back to All Requests
                </Link>
                <div>
                    <h1 className="text-3xl font-bold font-headline">New Sourcing Request</h1>
                    ...
                    <Card className="mt-6">
                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="budget">Budget per Item (INR)</Label>
