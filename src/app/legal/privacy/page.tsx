...
import { getTerms } from "@/lib/legal-service";

export default async function PrivacyPolicyPage() {
    // For simplicity, we'll show the same content, but this demonstrates fetching
    const { customer: privacyContent } = await getTerms();
